                    ...
                    <form action="{{route('attribute.store')}}" method="Post">
                        ...
                        <div class="addform-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <span class="m-1">
                                <input class="form-check-input" name="Is_variant" type="checkbox" value="yes" id="defaultRadio2">
                                 <label for="defaultCheck3">Yes</label>
                             </span>
                             <span class="m-1">
                                <input class="form-check-input" name="Is_variant" type="checkbox" value="no" id="defaultRadio2">
