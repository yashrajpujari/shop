        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header">
                    <h4 class="card-title fw-semibold mb-0 ">Add New Category</h4>
                </div>
                <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="parent_category" id="parentpage_category" class="form-select">
                                    ...
                                    <option value="{{$category->id}}"{{$category->id == old('parent_category')?"selected":""}}>{{$category->name}}</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    <div class="col-sm-10" style="display:inline-block;">
                                        <span class="m-1">
                                            <input class="form-check-input" name="show_in_menu" type="radio" {{old('show_in_menu')==1?"checked":""}} value="1" class="form-check-input" id="defaultRadio2">
                                            <label for="defaultCheck3">yes</label>
                                        </span>
                                        <span class="m-1">
                                            <input class="form-check-input" name="show_in_menu" type="radio" {{old('show_in_menu')==2?"checked":""}} value="2" class="form-check-input" id="defaultRadio2">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    ...
                                    <textarea name="shortDescription" class="form-control" placeholder="Description">{{ old('shortDescription') }}</textarea>
