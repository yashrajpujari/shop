...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="{{route('permission.index')}}" class="menu-link">
                    <div data-i18n="Without navbar">Permssions</div>
                  </a>
                </li>
                @endcan
                @can('role_index')
            ...
            @can('block_index')
            <li class="menu-item">
              <a href="{{route('block.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
            ...
            <li class="menu-item">
              <a href="{{route('contact.index')}}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
                <div data-i18n="Basic">Inquiries</div>
              </a>
            </li>
            @endcan
            ...
            <li class="menu-item">
                ...
                @endcan
            <!--    <li class="menu-item">
                  <a href="{{route('attributevalue.index')}}" class="menu-link">
                    <div data-i18n="Notifications"></div>
                  </a>
                </li>-->
                @can('order_index')
                <li class="menu-item">
                  <a href="{{route('customerorders')}}" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="{{route('customers')}}" class="menu-link">
                    <div data-i18n="Notifications">Customers</div>
                  </a>
                </li>
                @endcan
                @can('coupan_index')
                <li class="menu-item">
                  <a href="{{route('coupan.index')}}" class="menu-link">
                    <div data-i18n="Notifications">Coupans</div>
                  </a>
                </li>
                @endcan
