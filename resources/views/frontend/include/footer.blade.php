                    ...
                    <div class="row mb-n6">
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--green" data-aos="fade-up"
                                ...
                                <ul class="footer-nav"> 
                                    ...
                                    <li><a href="{{route('pages',$page->url_key)}}">{{$page->name}}</a></li>
                        ...
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--green" data-aos="fade-up"
                                ...
                                <ul class="footer-nav">
                                    <li><a href="{{route('customer/singin')}}">My account</a></li>
                                    @if(auth()->check())
                                    <li><a href="{{route('mywishlist.index')}}">Wishlist</a></li>@endif
                                    <li><a href="{{route('home')}}">Privacy Policy</a></li>
                                    <li><a href="{{route('home')}}">Frequently Questions</a></li>
                                    @if(auth()->check())
                                    <li><a href="{{route('orders')}}">Order History</a></li>@endif 
                                </ul>
                            </div>
                            <!-- End Footer Single Item -->
                        </div>
                        <div class="col-lg-3 col-sm-6 mb-6">
                            ...
                            <div class="footer-widget-single-item footer-widget-color--green" data-aos="fade-up"
                                ...
                                @foreach(get_header_category() as $category)
                                    <li><a href="{{route('categories',$category->url_key)}}">{{$category->name}}</a></li>
                                @endforeach
                                </ul>
                            </div>
                            <!-- End Footer Single Item -->
                    ...
                    <div
                        ...
                        <div class="col-auto mb-6">
                            <div class="footer-copyright">
                                <p class="copyright-text">&copy; 2023 <a href="{{route('home')}}">therankme</a>. Made with <i
                                        class="fa fa-heart text-danger"></i> by <a href="{{route('home')}}"
                                        target="_blank">@techzento</a> </p>
