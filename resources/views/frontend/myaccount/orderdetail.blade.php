    ...
    <div class="col-md-12">
      <div class="card shadow p-3 mb-5 bg-body rounded">
              ...
              <table class="table table-borderless">
                <tbody class="totals">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="text-right"> <span class="text-success">₹{{$order->coupan_discount??0}}</span> </div>
                    </td>
                  </tr>
        ...
        <div class="d-flex justify-content-center my-4">
          <button class="btn btn-success mx-3"><a href="{{route('view',$order->id)}}" style="color:white;" target="blank">Preview</a></button>
