                ...
                <form action="{{route('customer/store')}}" method="Post">
                  ...
                  <div class="row">
                    <div class="col-md-12 mb-4">
                      <div class="form-outline">
                        ...
                        <input type="text" id="form3Example1m" name="username" placeholder="username" value="{{old('username')}}" class="form-control form-control-lg" />
                      </div>
                      @error('username')
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12 mb-4">
                        <div class="form-outline">
                          ...
                          <input type="password" name="con_password" placeholder="***********" value="{{ old('con_password') }}" id="confirmPassword" class="form-control form-control-lg" />
                        </div>
                        @error('con_password')
                        <div class="text text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="d-flex justify-content-end pt-3">
                      ...
                      <button type="submit" class="btn btn-warning btn-lg ms-2" style="background:#047B42;color:white;">Resister</button>
                    </div>
